package com.quran.zquran.presentation
...
import com.quran.presentation.helper.Helper
import com.quran.presentation.helper.worker.KEY_IMAGE_URI
import com.quran.zquran.R
import com.quran.zquran.databinding.ActivityEditProfileBinding
import com.quran.zquran.presentation.viewmodel.ProfileViewModel
...
class EditProfileActivity : AppCompatActivity() {
    companion object {
        ...
        fun startActivity(context: Context) {
            context.startActivity(Intent(context, com.quran.zquran.presentation.EditProfileActivity::class.java))
        }
    }
    ...
    private fun handleSuccess(message: String) {
        ...
        com.quran.zquran.presentation.ProfileActivity.Companion.startActivity(this)
        this.finish()
    }
    ...
    private fun checkPermissions() {
        Helper.requestPermissions(
            ...
            requestCode = com.quran.zquran.presentation.EditProfileActivity.Companion.REQUEST_CODE_PERMISSION,
    ...
    private fun handleUploadProfileImage(image: Image) {
        val imagePart = MultipartBody.Part.createFormData(
            "image", image.name, RequestBody.create(
                com.quran.zquran.presentation.EditProfileActivity.Companion.MIME_TYPE_IMAGE.toMediaTypeOrNull(),
